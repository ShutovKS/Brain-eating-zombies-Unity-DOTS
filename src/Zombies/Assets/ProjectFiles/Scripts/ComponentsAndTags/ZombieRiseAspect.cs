...
namespace ComponentsAndTags
{
    ...
    public readonly partial struct ZombieWalkAspect : IAspect
    {
        ...
        public bool IsInStoppingRange(float3 brainPosition, float brainRadiusSquared)
        {
            return math.distancesq(brainPosition, _transform.ValueRO.Position) <= brainRadiusSquared;
        }
    }
